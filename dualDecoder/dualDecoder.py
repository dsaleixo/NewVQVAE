...
class DualDecoder(nn.Module):
    def __init__(
        ...
        self.decoder1 = TemporalDecoderSingleZq()
    ...
    def forward(
        ...
        #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxDecoder 1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        frames_gt = None
        if teacher_forcing:
        ...
        for t in range(n_frames):
            ...
            x_t = self.decoder1(z_q, x_prev)  # usa o mesmo z_q em cada passo
            recons.append(x_t)
        ...
        #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxdualDecoder 2xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        out2 = self.decoder2(z_q)
        return out_grid,out2, q_loss, indices, perplexity, used_codes
