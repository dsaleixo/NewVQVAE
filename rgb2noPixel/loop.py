...
from rgb2noPixel.rgb2nopixel import RGBnoPixel
...
def validation(model, val_loader: DataLoader, device='cuda',): 
        ...
        for batch in val_loader:
            ...
            loss_J =0
            loss = loss_recon*10 + vq_loss*0.1+0.001*kl_loss
    ...
    for epoch in range(num_epochs):
        ...
        for batch_idx, batch in enumerate(trainLoader):
            ...
            if epoch%10==0:
                ...
                torch.save(model.state_dict(), f"BestTrain{epoch}.pth")
                
                wandb.save(f"BestTrain{epoch}.pth")
